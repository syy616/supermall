<template>
  <div class="app">
    <FooterBar> 
        <FooterItem path="/home" activeColor="pink">
        ...
        <FooterItem path="/category" activeColor="pink">
        ...
        <FooterItem path="/cart" activeColor="pink">
        ...
        <FooterItem path="/profile" activeColor="deepPink">
